...
class CatRentalRequest < ActiveRecord::Base
  ...
  validate :owner_is_not_requester
  ...
  def owner_is_not_requester
    owner = Cat.find_by(id: self.cat_id).owner

    if self.user_id == owner.id
      errors[:requester_is_user] << "You can't rent your own cat!"
    end
  end
end
